...
#SBATCH --output=/ibex/user/guoj0f/StaB-ddG/MGnify-replace/ibex-records/ESM3ΔG-Megascale-SKEMPIv2/esm3dg_mega_skempi_aug1_20260630-115706_%j.out
#SBATCH --error=/ibex/user/guoj0f/StaB-ddG/MGnify-replace/ibex-records/ESM3ΔG-Megascale-SKEMPIv2/esm3dg_mega_skempi_aug1_20260630-115706_%j.err
set -euo pipefail
...
srun python -u finetune.py --stage megascale --lora_ckpt $LORA --split train --single_batch \
  ...
  --batch_tokens 4000 --max_batch 8 --seed 0 \
...
srun python -u eval.py --lora_ckpt $LORA --checkpoint ../cache/${RUN}.pt --split test \
  ...
  --out ../ibex-records/ESM3ΔG-Megascale-SKEMPIv2/results/eval_${RUN}.csv
echo "===== DONE ====="
